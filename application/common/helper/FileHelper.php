...
class FileHelper
{
    ...
    public static function getFileTypeByExtension($extension)
    {
        ...
        if (in_array($extension, array('mp4', '3gp', 'avi', 'mpg', 'flv', 'f4v', 'wmv', 'mov', 'rmvb', 'mkv'))) {
            return 'video';
        } elseif (in_array($extension, array('mp3', 'wma'))) {
            return 'audio';
        } elseif (in_array($extension, array('jpg', 'jpeg', 'png', 'gif', 'bmp'))) {
            return 'image';
        } elseif (in_array($extension, array('doc', 'docx', 'pdf', 'xls', 'xlsx', 'wps', 'odt', 'ppt', 'pptx'))) {
            return 'document';
